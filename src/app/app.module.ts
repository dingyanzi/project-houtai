...
import { RoleService } from './routerole';
...
@NgModule({
  ...
  providers:[ PreviewimgService,AuthService,RoleService,{provide: LocationStrategy, useClass: HashLocationStrategy},CanLeaveProvide,{ provide: NZ_NOTIFICATION_CONFIG, useValue: { nzTop: "64px" } }],
